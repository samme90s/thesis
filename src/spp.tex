...
% SAM: Förstår inte riktigt här, känns som vi riktar oss mot maskininlärning istället för LLMs,
% men kan ha förstått fel?
This can result in problems when it comes to scalability and handling different text formats.
% SAM: Källa, eftersom det är ett påstående!
...
% SAM: Behövs skrivas om för bättre flöde!

\subsubsection{Work Orders}

% SAM: sammanfogade två stycken här, men ändrade inget i texten förutom det jag tidigare skrev.
...
% HAMPUS: Vet inte om jag gillar det jag har skrivit om WOs som du ser ovan.
% SAM: Funderar på om vi ska flytta något till related work här ifrån.
...
% SAM: Hittade en rätt bra källa kring IKEA och LLMs i samband med "Transaction classification"
% men förklarade LLMs rätt bra, funderar på om vi ska sno den källan istället för andersson2024
% som jag använder nu.
...
% SAM: Måste integreras bättre med föregående stycke!
...
% SAM: Behöver skrivas om för bättre flöde.
